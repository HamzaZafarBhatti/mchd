...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.kpi_big_project_detail'); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="bg-soft-primary">
                    <div class="card-body pb-0 px-4">
                        ...
                        <ul class="nav nav-tabs-custom border-bottom-0" role="tablist" id="myTab">
                            ...
                            <li class="nav-item">
                                <a class="nav-link fw-semibold" data-bs-toggle="tab" href="#project-dashboard" role="tab">
                                    Charts
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="col-xl-9 col-lg-8">
                            <div class="card border">
                                <div class="card-header border-bottom-dashed align-items-center d-flex">
                                    ...
                                    <?php if(\App\Helper\Helper::clinicBigProjectEditable(auth()->user(), $big_project)): ?>
                                ...
                                <div class="card-body">
                                    <div class="text-muted">
                                        <div class="ql-editor">
                                            <?php echo $big_project->description; ?>
                                        ...
                                        <div class="pt-3 border-top border-top-dashed mt-4">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <h5 class="fs-15 mb-0"><?php echo e(\App\Helper\Helper::letter_date($big_project->start_date)); ?></h5>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        <p class="mb-2 text-uppercase fw-medium">Due Date :</p>
                                                        <h5 class="fs-15 mb-0"><?php echo e(\App\Helper\Helper::letter_date($big_project->end_date)); ?></h5>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-sm-6 mb-3">
                                                    <div>
                                                        ...
                                                        <div class="badge bg-<?php echo e(\App\Helper\Helper::getStatusColor($big_project->status)); ?> fs-12"><?php echo e(\App\Helper\Helper::getStatus(0, $big_project->status)); ?></div>
                                                    </div>
                                                </div>

                                                <div class="col-lg-3 col-sm-6">
                                                    <?php if(\App\Helper\Helper::statusChangeable(auth()->user(), $big_project)): ?>
                                                        ...
                                                        <div class="mb-4">
                                                            <form id="form_status" method="post" action="<?php echo e(url('clinic/change_status')); ?>">
                                                                ...
                                                                <input type="hidden" name="id" value="<?php echo e($big_project->id); ?>">
                                                                <select id="change_status" class="form-control" name="status" data-choices data-choices-search-false>
                                                                    <?php $__currentLoopData = config('constants.big_project_status'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if($key !== "all"): ?>
                                                                            <option <?php echo e($big_project->status == $key? 'selected' : ''); ?> value="<?php echo e($key); ?>"><?php echo e($val); ?></option>
                                                                        <?php endif; ?>
                                            ...
                                            <div class="pt-3 border-top border-top-dashed mt-4 d-flex justify-content-end">
                                                <a href="<?php echo e(url('kpibiglist/'.$big_project->department_code)); ?>" class="btn btn-outline-danger w-sm me-1">Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4">
                            <div class="card">
                                <div class="card-header align-items-center border-bottom-dashed">
                                    <h4 class="card-title mb-0 text-center"><?php echo e($big_project->department->name); ?></h4>
                                </div>
                                <div class="card-header align-items-center d-flex justify-content-between border-bottom-dashed">
                                    ...
                                    <div class="float-lg-end">
                                        <?php echo \App\Helper\Helper::avatar($big_project->boss->avatar, $big_project->boss->name, 'avatar-xs', 11, auth() && auth()->user()->id === $big_project->boss->id); ?>
                                ...
                                <div class="card-header align-items-center d-flex border-bottom-dashed">
                                    ...
                                    <?php if(\App\Helper\Helper::clinicBigProjectEditable(auth()->user(), $big_project)): ?>
                                        <div class="flex-shrink-0">
                                            <button data-bs-toggle="modal" onclick="open_invite_modal()" type="button" class="btn btn-soft-danger btn-sm"><i
                                ...
                                <div class="card-body">
                                    <div data-simplebar style="height: 235px;" class="mx-n3 px-3">
                                        <div class="vstack gap-3">
                                            <?php $__currentLoopData = $big_project->assignUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex border-bottom-dashed">
                                    ...
                                    <?php if(\App\Helper\Helper::clinicBigProjectEditable(auth()->user(), $big_project)): ?>
                                        <div class="flex-shrink-0">
                                            <a data-bs-toggle="modal" data-bs-target="#modal_uplaod" href="#" class="btn btn-soft-info btn-sm"><i
                                ...
                                <div class="card-body">
                                    <div class="vstack gap-2">
                                        <?php $__currentLoopData = $big_project->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        <div class="flex-grow-1">
                            <div class="hstack text-nowrap gap-2">
                                Projects <span class="badge badge-danger badge-soft-secondary"><?php echo e(count($big_project->projects)); ?></span>
                            </div>
                        </div>

                        <?php if(\App\Helper\Helper::clinicProjectCreatable(auth()->user(), $big_project)): ?>
                            <div class="flex-shrink-0">
                                <a href="<?php echo e(url('kpiproject/create/'.$big_project->id)); ?>" class="btn btn-info add-btn">
                ...
                <div class="card-body">
                    <div class="row">
                        <!-- end col -->
                        <?php $__currentLoopData = $big_project->projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-0 fs-14 text-center">
                                                        <a href="<?php echo e(url('kpiproject/detail/'.$item->id)); ?>" class="text-dark">
                                                    ...
                                                    <div class="d-flex gap-1 align-items-center my-n2">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="<?php echo e(url('kpiproject/detail/'.$item->id)); ?>"><i
                                                                        class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                    View</a>

                                                                <?php if(\App\Helper\Helper::clinicProjectEditable(auth()->user(), $item)): ?>
                                                                <a class="dropdown-item" href="<?php echo e(url('kpiproject/edit/'.$item->id)); ?>"><i
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                                ...
                                                <div class="avatar-group">
                                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                                       data-bs-trigger="hover" data-bs-placement="top" title="<?php echo e($item->user->name); ?>">
                                                        <?php echo \App\Helper\Helper::avatar($item->user->avatar, $item->user->name, 'avatar-xxs', 11, auth() && auth()->user()->id === $item->user->id); ?>

                                                    </a>
                                                </div>

                                                <p class="text-muted ms-auto mb-0 me-2">Tasks : <span class="badge badge-soft-secondary"> <?php echo e($item->tasks->count()); ?></span></p>
                                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form id="form" method="post" action="<?php echo e(url('kpibigproject/invite/'.$big_project->id)); ?>">
                        <input name="id" type="hidden" value="<?php echo e($big_project->id); ?>">
                        <?php echo csrf_field(); ?>
                    </form>
    ...
    <div id="modal_delete_leader" class="modal bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        ...
                        <form method="post" action="<?php echo e(url('kpibigproject/delete_leader/'.$big_project->id)); ?>">
                            <?php echo e(csrf_field()); ?>

                            <input type="hidden" name="leader_id" value="">
                            <input type="hidden" name="big_project_id" value="<?php echo e($big_project->id); ?>">
    ...
    <div id="modal_delete_attachment" class="modal bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    <lord-icon src="https://cdn.lordicon.com/gsqxdxog.json"
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                        <form method="post" action="<?php echo e(url('kpibigproject/delete_attachment/'.$big_project->id)); ?>">
                            <?php echo e(csrf_field()); ?>
    ...
    <div class="modal fade" id="modal_uplaod" tabindex="-1" aria-labelledby=""
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="form" method="post" action="<?php echo e(url('kpibigproject/upload_file/'.$big_project->id)); ?>" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                            <input name="id" type="hidden" value="<?php echo e($big_project->id); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
    ...
    <div id="removeProjectModal" class="modal zoomIn" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form id="form_delete_project" method="post" action="<?php echo e(url('kpiproject/delete_project')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <div class="modal fade zoomIn" id="edit_modal" tabindex="-1" aria-labelledby="editbigprojectmodal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form id="edit_task" action="<?php echo e(url('kpibigproject/m_edit')); ?>" method="post" class="needs-validation" enctype="multipart/form-data">
                    <?php echo e(csrf_field()); ?>

                    <input type="hidden" value="<?php echo e($big_project->id); ?>" name="id">
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="mb-3">
                                    <label class="form-label" for="project-title-input">Big Project Title</label>
                                    <input name="name" type="text" class="form-control" id="project-title-input" value="<?php echo e($big_project->name); ?>" placeholder="Enter big project title">
                                </div>
                                <div class="mb-3">
                                    <div class="snow-editor" id="ckeditor-classic" style="height: 300px"><?php echo $big_project->description; ?></div>
                                </div>
                            </div>
                        </div>
                        <!--end row-->
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input name="start_date" value="<?php echo e($big_project->start_date); ?>" type="text" class="form-control" id="datepicker-start-input"
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input name="end_date" value="<?php echo e($big_project->end_date); ?>" type="text" class="form-control" id="datepicker-deadline-input"
                                           placeholder="Enter due date" data-provider="flatpickr">
                                </div>
                            </div>
                        </div>
...
<?php $__env->startSection('script-bottom'); ?>
    <script>
        ...
        let user_list = <?php echo json_encode($big_project->assignUsers, 15, 512) ?>;
        ...
        $(document).ready(function (){
            ...
            $.ajax({
                url: '<?php echo e(url('kpibigproject/chart')); ?>',
                method: 'post',
                data: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\mchd-manager\resources\views/kpibigproject/detail.blade.php ENDPATH**/ ?>