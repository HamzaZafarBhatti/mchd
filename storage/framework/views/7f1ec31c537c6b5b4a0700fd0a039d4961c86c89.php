<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.create_project'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form id="form" method="post" action="<?php echo e(url('project/create/'.$big_project_id)); ?>" enctype="multipart/form-data">
        <div class="row">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\mchd-manager\resources\views/project/create.blade.php ENDPATH**/ ?>