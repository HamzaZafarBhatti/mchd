...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="col-md">
                                <div class="row align-items-center g-3">
                                    <div class="col-md-auto">
                                        <?php echo \App\Helper\Helper::avatar($task->leader->avatar, $task->leader->name, 'avatar-md', 30, auth() && auth()->user()->id === $task->leader->id); ?>

                                    </div>
                                    <div class="col-md">
                                        <div>
                                            <h4 class="fw-bold"><?php echo e($task->name); ?></h4>
                                            <div class="hstack gap-3 flex-wrap">
                                                <div>Department : <span class="fw-medium"><?php echo e($task->department->name); ?></span></div>
                                                <div class="vr"></div>
                                                <div>Leader : <span class="fw-medium"><?php echo e($task->leader->name); ?></span></div>
                                                <div class="vr"></div>
                                                <div>Create Date : <span class="fw-medium"><?php echo e(\App\Helper\Helper::letter_date($task->created_at)); ?></span></div>
                                                <div class="vr"></div>
                                                <div>Start Date : <span class="fw-medium"><?php echo e(\App\Helper\Helper::letter_date($task->start_date)); ?></span></div>
                                                <div class="vr"></div>
                                                <div>Due Date : <span class="fw-medium"><?php echo e(\App\Helper\Helper::letter_date($task->end_date)); ?></span></div>
                                                <div class="vr"></div>
                                                <?php if(\App\Helper\Helper::isNew($task->created_at)): ?>
                                    ...
                                    <div class="text-muted">
                                        ...
                                        <div class="pt-3 border-top border-top-dashed mt-4">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <h5 class="fs-15 mb-0"><?php echo e(\App\Helper\Helper::letter_date($task->start_date)); ?></h5>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        <p class="mb-2 text-uppercase fw-medium">Due Date :</p>
                                                        <h5 class="fs-15 mb-0"><?php echo e(\App\Helper\Helper::letter_date($task->end_date)); ?></h5>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-sm-6 mb-3">
                                                    <div>
                                                        ...
                                                        <div class="badge bg-<?php echo e(\App\Helper\Helper::getStatusColor($task->status)); ?> fs-12"><?php echo e(\App\Helper\Helper::getStatus(0, $task->status)); ?></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="pt-3 border-top border-top-dashed mt-4 d-flex justify-content-end">
                                                <a href="<?php echo e(url('project/detail/'.$task->project->id)); ?>" class="btn btn-outline-danger w-sm me-1">Back</a>
                                                <?php if(\App\Helper\Helper::clinicTaskEditable(auth()->user(), $task)): ?>
                                                    <a href="<?php echo e(url('task/edit/'.$task->id)); ?>" class="btn btn-outline-success">Edit</a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-4">
                            <div class="card">
                                <div class="card-header align-items-center border-bottom-dashed">
                                    <h4 class="card-title mb-0 text-center"><?php echo e($task->department->name); ?></h4>
                                </div>
                                <div class="card-header align-items-center d-flex justify-content-between border-bottom-dashed">
                                    ...
                                    <div class="float-lg-end">
                                        <?php echo \App\Helper\Helper::avatar($task->leader->avatar, $task->leader->name, 'avatar-xs', 11, auth() && auth()->user()->id === $task->leader->id); ?>
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        <div class="flex-grow-1">
                            <div class="hstack text-nowrap gap-2">
                                Sub Tasks <span class="badge badge-danger badge-soft-secondary"><?php echo e($task->subTasks->count()); ?></span>
                            </div>
                        </div>

                        <?php if(\App\Helper\Helper::clinicSubTaskCreatable(auth()->user(), $task)): ?>
                        <div class="flex-shrink-0">
                            <a href="<?php echo e(url('subtask/create/'.$task->id)); ?>" class="btn btn-info add-btn">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-0 fs-14 text-center">
                                                        <a href="<?php echo e(url('subtask/detail/'.$item->id)); ?>" class="text-dark">
                                                    ...
                                                    <div class="d-flex gap-1 align-items-center my-n2">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="<?php echo e(url('subtask/detail/'.$item->id)); ?>"><i
                                                                        class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                    View</a>
                                                                <?php if(\App\Helper\Helper::clinicSubTaskEditable(auth()->user(), $item)): ?>
                                                                <a class="dropdown-item" href="<?php echo e(url('subtask/edit/'.$item->id)); ?>"><i
                                                                        class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                                    Edit</a>
                                                                <div class="dropdown-divider"></div>
                                                                <a class="dropdown-item" href="javascript:open_modal_delete_bigproject(<?php echo e($item->id); ?>)"><i
                                                                        class="ri-delete-bin-fill align-bottom me-2 text-muted"></i>
                                                                    Remove</a>
                                                                <?php endif; ?>
                                                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form id="form" method="post" action="<?php echo e(url('task/invite/'.$task->id)); ?>">
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        ...
                        <form method="post" action="<?php echo e(url('task/delete_member/'.$task->id)); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                        <form method="post" action="<?php echo e(url('task/delete_attachment/'.$task->id)); ?>">
                            <?php echo e(csrf_field()); ?>
    ...
    <div class="modal fade" id="modal_uplaod" tabindex="-1" aria-labelledby=""
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="form" method="post" action="<?php echo e(url('task/upload_file/'.$task->id)); ?>" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                            <input name="id" type="hidden" value="<?php echo e($task->id); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
    ...
    <div id="removeProjectModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form id="form_delete_project" method="post" action="<?php echo e(url('subtask/delete_project')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mchdmana/public_html/resources/views/task/detail.blade.php ENDPATH**/ ?>