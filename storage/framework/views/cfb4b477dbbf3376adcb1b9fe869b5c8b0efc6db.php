...
<?php $__env->startSection('content'); ?>
    ...
    <form id="form" method="post" action="<?php echo e(url('task/create/'.$project_id)); ?>" enctype="multipart/form-data">
        <div class="row">
            <?php echo csrf_field(); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input name="name" type="text" class="form-control" id="project-title-input" placeholder="Enter Task title">
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="text-end mb-4">
                    ...
                    <?php if(\App\Helper\Helper::clinicTaskCreatable(auth()->user(), \App\Models\Project::findOrFail($project_id))): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mchdmana/public_html/resources/views/task/create.blade.php ENDPATH**/ ?>