    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                <li class="menu-title">
                    <span><?php echo app('translator')->get('translation.project_management'); ?></span></li>
                <li class="nav-item">
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown <?php echo e(Request::is(["dashboard/1", "dashboard/2", "dashboard/3", "dashboard/4" , "dashboard/5", '/']) ? "show" : ""); ?>" id="dashboard">
                        <ul class="nav nav-sm flex-column">
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item">
                                    <a class="nav-link <?php echo e(Request::is("dashboard/".$item->id)? "active" : ""); ?>" href="<?php echo e(url('dashboard/'.$item->id)); ?>">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php if($current_user->role != 2): ?>
                        <li class="nav-item">
                            <a class="nav-link menu-link <?php echo e(Request::is(['tasks/'.$current_user->department_code, 'biglist/'.$current_user->department_code,
                            'bigcreate/'.$current_user->department_code]) ? 'active' : ''); ?>" href="<?php echo e(url('/tasks/'.$current_user->department_code)); ?>">
                                <i class="<?php echo e($current_user->department->icon); ?>"></i> <span><?php echo e($current_user->department->name); ?></span>
                            </a>
                        </li>
                        ...
                        <?php $__currentLoopData = $current_user->details()->groupBy('department_code')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link <?php echo e(Request::is('tasks/'.$item->department->code) ? 'active' : ''); ?>" href="<?php echo e(url('/tasks/'.$item->department->code)); ?>">
                                    <i class="<?php echo e($item->department->icon); ?>"></i> <span><?php echo e($item->department->name); ?></span>
                                </a>
                            </li>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-item">
                                <a class="nav-link menu-link <?php echo e(Request::is('tasks/'.$item->code) ? 'active' : ''); ?>" href="<?php echo e(url('/tasks/'.$item->code)); ?>">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link <?php echo e(Request::is('admin/chart') ? 'active' : ''); ?>" href="<?php echo e(url('admin/chart')); ?>">
                                    <i class="ri-pie-chart-2-line"></i> <span><?php echo app('translator')->get('translation.charts'); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link menu-link <?php echo e(Request::is('admin/usermanagement') ? 'active' : ''); ?>" href="<?php echo e(url('admin/usermanagement')); ?>">
                                    <i class="ri-user-3-fill"></i> <span><?php echo app('translator')->get('translation.usermanagement'); ?></span>
                                </a>
                            </li>

                            <li class="menu-title">
                                <span><?php echo app('translator')->get('translation.kpi'); ?></span></li>
                            <li class="nav-item">
                            <li class="nav-item">
...
<?php /**PATH /home/mchdmana/public_html/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>