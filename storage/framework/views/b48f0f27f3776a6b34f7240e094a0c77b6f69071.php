...
<?php $__env->startSection('content'); ?>
    <div class="modal fade zoomIn" id="createTaskModal" tabindex="-1" aria-labelledby="createTaskModelLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content border-0">
                ...
                <form action="<?php echo e(url('create_task')); ?>" method="post">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div data-simplebar style="max-height: 350px;">
                                        <ul class="list-unstyled vstack gap-2 mb-0">
                                            <?php $__currentLoopData = $project->assignUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li>
                                                    <div class="form-check d-flex align-items-center">
                                                        <input class="form-check-input me-3" type="checkbox" name="assignedTo[]"
                                                               value="<?php echo e($user->id); ?>" id="<?php echo e($user->id); ?>">
                                    ...
                                    <div class="col-md">
                                        <div>
                                            ...
                                            <div class="hstack gap-3 flex-wrap">
                                                ...
                                                <div>Start Date : <span
                                                        class="fw-medium"><?php echo e($project->start_date); ?></span></div>
                                                <div class="vr"></div>
                                                <div>End Date : <span class="fw-medium"><?php echo e($project->end_date); ?></span>
                                                </div>
                                                <div class="vr"></div>
                                                <div
                                                    class="badge rounded-pill bg-<?php echo e(config('constants.status_color')[$project->status]); ?> fs-12"><?php echo e(config('constants.project_status')[$project->status]); ?></div>
    ...
    <div class="row">
        <div class="col-xl-9 col-lg-8">
            <div class="card">
                <div class="card-body">
                    <div class="text-muted">
                        ...
                        <div class="ql-editor"><?php echo $project->description; ?></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div>
                                        ...
                                        <h5 class="fs-15 mb-0"><?php echo e($project->start_date); ?></h5>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6">
                                    <div>
                                        <p class="mb-2 text-uppercase fw-medium">End Date :</p>
                                        <h5 class="fs-15 mb-0"><?php echo e($project->end_date); ?></h5>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div>
                                        ...
                                        <div class="badge bg-<?php echo e(config('constants.status_color')[$project->status]); ?> fs-12"><?php echo e(config('constants.project_status')[$project->status]); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <?php if(auth()->user()->id == $project->leader_id): ?>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="fs-13 mb-1"><a href="#"
                                                                  class="text-body text-truncate d-block"><?php echo e($project->attach_origin_name); ?></a>
                                        </h5>
                                        
                                    </div>
                                    <div class="flex-shrink-0 ms-2">
                                        <div class="d-flex gap-1">
                                            <a href="<?php echo e(asset('public/attaches/'.$project->attach_path)); ?>"
    ...
    <div class="modal fade zoomIn" id="createProjectModal" tabindex="-1" aria-labelledby="createProjectModelLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content border-0">
                ...
                <form action="<?php echo e(url('update_project')); ?>" method="post" enctype="multipart/form-data" class="needs-validation">
                    <?php echo e(csrf_field()); ?>

                    <input name="project_id" type="hidden" value="<?php echo e($project->id); ?>">
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-8 col-md-8 col-sm-12">
                                <div class="col-lg-12">
                                    <label for="project_name" class="form-label">Project Name</label>
                                    <input type="text" id="project_name" class="form-control" name="name" value="<?php echo e($project->name); ?>" placeholder="Project name"
                                           required />
                                </div>
                                <!--end col-->
                                <div class="col-lg-12">
                                    <div class="mt-3">
                                        ...
                                        <div style="height: 300px" id="project_definition_aims" class="project-snow-editor"><?php echo $project->definition_aims; ?></div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-3">
                                        ...
                                        <input type="text" id="project_start_date" class="form-control" name="start_date" data-provider="flatpickr"
                                               placeholder="Due date" required value="<?php echo e($project->start_date); ?>"/>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-3">
                                        ...
                                        <input type="text" id="project_end_date" class="form-control" name="end_date" data-provider="flatpickr"
                                               placeholder="Due date" required value="<?php echo e($project->end_date); ?>" />
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-6 col-md-6 col-sm-6 mt-3">
                                        ...
                                        <select class="form-control" data-choices data-choices-search-false name="status" id="project_status">
                                            ...
                                            <?php $__currentLoopData = config('constants.project_status'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($key !== "all"): ?>
                                                    <option <?php echo e($key===$project->status? "selected" : ""); ?> value="<?php echo e($key); ?>"><?php echo e($val); ?></option>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <select
                                        ...
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php ($flag = false); ?>
                                            <?php $__currentLoopData = $project->assignUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $selectedUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                ...
                                                ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($flag? "selected" : ""); ?> value="<?php echo e($user->id); ?>"><?php echo e($user->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        ...
                        <form method="post" action="<?php echo e(url('delete_project')); ?>">
                            <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mchdmana/public_html/resources/views/project/project.blade.php ENDPATH**/ ?>