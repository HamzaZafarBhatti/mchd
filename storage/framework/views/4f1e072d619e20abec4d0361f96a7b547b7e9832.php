<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.kpi_project_detail'); ?>
                                    ...
                                    <div class="text-muted">
                                        ...
                                        <div class="pt-3 border-top border-top-dashed mt-4">
                                            ...
                                            <div class="pt-3 border-top border-top-dashed mt-4 d-flex justify-content-end">
                                                <a href="<?php echo e(url('kpibigproject/detail/'.$project->big_project->id)); ?>" class="btn btn-outline-danger w-sm me-1">Back</a>
                                                <?php if(\App\Helper\Helper::clinicProjectEditable(auth()->user(), $project)): ?>
                                                    <a href="<?php echo e(url('kpiproject/edit/'.$project->id)); ?>" class="btn btn-outline-success">Edit</a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form id="form" method="post" action="<?php echo e(url('kpiproject/invite/'.$project->id)); ?>">
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        ...
                        <form method="post" action="<?php echo e(url('kpiproject/delete_member/'.$project->id)); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                        <form method="post" action="<?php echo e(url('kpiproject/delete_attachment/'.$project->id)); ?>">
                            <?php echo e(csrf_field()); ?>
    ...
    <div class="modal fade" id="modal_uplaod" tabindex="-1" aria-labelledby=""
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="form" method="post" action="<?php echo e(url('kpiproject/upload_file/'.$project->id)); ?>" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                            <input name="id" type="hidden" value="<?php echo e($project->id); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\mchd-manager\resources\views/kpiproject/detail.blade.php ENDPATH**/ ?>