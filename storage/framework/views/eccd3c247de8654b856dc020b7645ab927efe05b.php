                        ...
                        <div class="text-center mt-sm-5 text-white-50">
                            <div>
                                <a href="<?php echo e(url('/')); ?>" class="d-inline-block auth-logo">
                                    <img src="<?php echo e(URL::asset('assets/images/logo-light.png')); ?>" alt="" height="36">
                                </a>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="department_code" required class="form-select form-control <?php $__errorArgs = ['department'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4 text-center">
                            ...
                            <p class="mb-0"><a href="<?php echo e(url('/')); ?>" class="fw-semibold text-primary text-decoration-underline"> Go to dashboard </a> </p>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mchdmana/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>