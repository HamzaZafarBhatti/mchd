        ...
        <div class="col-xxl-3">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <form id="form_status" method="post" action="<?php echo e(url('tasks/sub_change_status')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <select id="change_status" class="form-control" name="status" data-choices data-choices-search-false>
                                <?php $__currentLoopData = config('constants.sub_task_status'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($key !== "all"): ?>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        ...
                        <?php if(\App\Helper\Helper::otherSubTaskEditable(auth()->user(), $task)): ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form id="form" method="post" action="<?php echo e(url('tasks/sub_invite/')); ?>">
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        ...
                        <form method="post" action="<?php echo e(url('tasks/sub_delete_member/')); ?>">
    ...
    <div class="modal fade zoomIn" id="edit_modal" tabindex="-1" aria-labelledby="createProjectModelLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form id="edit_task" action="<?php echo e(url('tasks/sub_edit')); ?>" method="post" class="needs-validation" enctype="multipart/form-data">
                    <?php echo e(csrf_field()); ?>
    ...
    <div class="modal fade" id="modal_uplaod" tabindex="-1" aria-labelledby=""
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="form" method="post" action="<?php echo e(url('tasks/sub_upload_file/')); ?>" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                        <input name="id" type="hidden" value="<?php echo e($task->id); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                        <form method="post" action="<?php echo e(url('tasks/sub_delete_attachment/')); ?>">
                            <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mchdmana/public_html/resources/views/other/sub_detail.blade.php ENDPATH**/ ?>