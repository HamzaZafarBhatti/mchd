...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <div class="text-muted">
                                        ...
                                        <div class="pt-3 border-top border-top-dashed mt-4">
                                            ...
                                            <div class="pt-3 border-top border-top-dashed mt-4 d-flex justify-content-end">
                                                <a href="<?php echo e(url('biglist/'.$big_project->department_code)); ?>" class="btn btn-outline-danger w-sm me-1">Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card-header bg-soft-primary">
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        ...
                        <?php if(\App\Helper\Helper::clinicProjectCreatable(auth()->user(), $big_project)): ?>
                            <div class="flex-shrink-0">
                                <a href="<?php echo e(url('project/create/'.$big_project->id)); ?>" class="btn btn-info add-btn">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-0 fs-14 text-center">
                                                        <a href="<?php echo e(url('project/detail/'.$item->id)); ?>" class="text-dark">
                                                    ...
                                                    <div class="d-flex gap-1 align-items-center my-n2">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="<?php echo e(url('project/detail/'.$item->id)); ?>"><i
                                                                        class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                    View</a>

                                                                <?php if(\App\Helper\Helper::clinicProjectEditable(auth()->user(), $item)): ?>
                                                                <a class="dropdown-item" href="<?php echo e(url('project/edit/'.$item->id)); ?>"><i
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form id="form" method="post" action="<?php echo e(url('bigproject/invite/'.$big_project->id)); ?>">
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        ...
                        <form method="post" action="<?php echo e(url('bigproject/delete_leader/'.$big_project->id)); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                        <form method="post" action="<?php echo e(url('bigproject/delete_attachment/'.$big_project->id)); ?>">
                            <?php echo e(csrf_field()); ?>
    ...
    <div class="modal fade" id="modal_uplaod" tabindex="-1" aria-labelledby=""
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="form" method="post" action="<?php echo e(url('bigproject/upload_file/'.$big_project->id)); ?>" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                            <input name="id" type="hidden" value="<?php echo e($big_project->id); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
    ...
    <div id="removeProjectModal" class="modal zoomIn" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form id="form_delete_project" method="post" action="<?php echo e(url('project/delete_project')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <div class="modal fade zoomIn" id="edit_modal" tabindex="-1" aria-labelledby="editbigprojectmodal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form id="edit_task" action="<?php echo e(url('bigproject/m_edit')); ?>" method="post" class="needs-validation" enctype="multipart/form-data">
                    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mchdmana/public_html/resources/views/bigproject/detail.blade.php ENDPATH**/ ?>