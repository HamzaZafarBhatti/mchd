...
<?php $__env->startSection('content'); ?>
    ...
    <form id="form" method="post" action="<?php echo e(url('create_kpi_big_project')); ?>" enctype="multipart/form-data">
    <div class="row">
        <input value="<?php echo e($code); ?>" name="code" type="hidden">
        <?php echo csrf_field(); ?>
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="vstack gap-3" id="members_container">
                            <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="d-flex align-items-center member_item">
                                    ...
                                    <div class="flex-shrink-0">
                                        <button type="button" class="btn btn-light btn-sm" onclick="add_user(this, <?php echo e(json_encode($item)); ?>)">Add</button>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\mchd-manager\resources\views/kpibigproject/bigcreate.blade.php ENDPATH**/ ?>