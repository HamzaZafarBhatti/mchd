...
<?php $__env->startSection('content'); ?>
    ...
    <form id="form" method="post" action="<?php echo e(url('subtask/edit/'.$sub_task->id)); ?>" enctype="multipart/form-data">
        <input type="hidden" value="<?php echo e($sub_task->id); ?>" name="id">
        <div class="row">
            <?php echo csrf_field(); ?>
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input name="name" type="text" class="form-control" id="project-title-input" value="<?php echo e($sub_task->name); ?>" placeholder="Enter project title">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Project Description</label>
                            <div class="snow-editor" id="ckeditor-classic" style="height: 300px"><?php echo $sub_task->description; ?></div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input name="start_date" value="<?php echo e($sub_task->start_date); ?>" type="text" class="form-control" id="datepicker-start-input"
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input name="end_date" value="<?php echo e($sub_task->end_date); ?>" type="text" class="form-control" id="datepicker-deadline-input"
                                           placeholder="Enter due date" data-provider="flatpickr">
                                </div>
                            </div>
                        </div>
                ...
                <div class="text-end mb-4">
                    ...
                    <?php if(\App\Helper\Helper::clinicTaskCreatable(auth()->user(), $sub_task)): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mchdmana/public_html/resources/views/subtask/edit.blade.php ENDPATH**/ ?>