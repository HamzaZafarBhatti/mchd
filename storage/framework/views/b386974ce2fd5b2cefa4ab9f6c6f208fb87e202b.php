<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.kpi_big_project_list'); ?>
        ...
        <div class="col-sm-auto">
            <div>
                <?php if(\App\Helper\Helper::clinicBigProjectCreatable(auth()->user(), $code)): ?>
                    <a href="<?php echo e(url('kpibigcreate/'.$code)); ?>" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Create New</a>
                <?php endif; ?>
            </div>
        </div>
        <div class="col-sm">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <h5 class="mb-0 fs-14 text-center">
                                        <a href="<?php echo e(url('kpibigproject/detail/'.$item->id)); ?>" class="text-dark">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\mchd-manager\resources\views/kpibigproject/biglist.blade.php ENDPATH**/ ?>