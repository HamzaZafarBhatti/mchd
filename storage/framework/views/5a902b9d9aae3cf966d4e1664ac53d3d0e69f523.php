...
<?php $__env->startSection('content'); ?>
    ...
    <form id="form" method="post" action="<?php echo e(url('bigproject/edit/'.$big_project->id)); ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="text-end mb-4">
                    <a href="<?php echo e(url('bigproject/detail/'.$big_project->id)); ?>" class="btn btn-danger w-sm">Back</a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mchdmana/public_html/resources/views/bigproject/edit.blade.php ENDPATH**/ ?>