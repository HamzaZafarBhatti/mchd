<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.create_kpi_big_project'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form id="form" method="post" action="<?php echo e(url('kpiproject/edit/'.$project->id)); ?>" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input name="name" type="text" class="form-control" id="project-title-input" value="<?php echo e($project->name); ?>" placeholder="Enter project title">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Project Description</label>
                            <div class="snow-editor" id="ckeditor-classic" style="height: 300px"><?php echo $project->description; ?></div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input name="start_date" value="<?php echo e($project->start_date); ?>" type="text" class="form-control" id="datepicker-start-input"
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input name="end_date" value="<?php echo e($project->end_date); ?>" type="text" class="form-control" id="datepicker-deadline-input"
                                           placeholder="Enter due date" data-provider="flatpickr">
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\mchd-manager\resources\views/kpiproject/edit.blade.php ENDPATH**/ ?>