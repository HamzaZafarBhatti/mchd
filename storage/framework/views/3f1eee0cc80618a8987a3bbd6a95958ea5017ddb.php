<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.create_kpi_project'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form id="form" method="post" action="<?php echo e(url('kpiproject/create/'.$big_project_id)); ?>" enctype="multipart/form-data">
        <div class="row">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="big_project_id" value="<?php echo e($big_project_id); ?>">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\mchd-manager\resources\views/kpiproject/create.blade.php ENDPATH**/ ?>