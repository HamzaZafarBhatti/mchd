...
class KpiProjectController extends Controller
{
    ...
    public function project_create($big_project_id)
    {
        ...
        return view('kpiproject.create', compact('members', 'big_project_id'));
    }
    ...
    public function post_project(Request $request)
    {
        ...
        return redirect('/kpibigproject/detail/' . $big_project_id)->with('success', 'Created project successfully');
    }
    ...
    public function project_edit($project_id)
    {
        ...
        return view('kpiproject.edit', compact('project'));
    }
    ...
    public function p_project_edit(Request $request)
    {
        ...
        KpiProject::where('id', $id)->update($data);
        return redirect("kpiproject/detail/" . $id)->with('success', 'Updated successfully.');
    }
    ...
    public function delete_member(Request $request)
    {
        ...
        KpiProjectAssignee::where('project_id', $project_id)->where('user_id', $member_id)->delete();
    ...
    public function delete_project_v2(Request $request)
    {
        ...
        $project_id = $request->project_id;
        $attaches = KpiProAttachment::where('pro_id', $project_id)->get();
        ...
        KpiProject::findOrFail($project_id)->delete();
        return redirect()->back()->with('success', "Deleted successfully.");
    }
    ...
    public function project_delete_attachment(Request $request)
    {
        ...
        $big_project = KpiProAttachment::find($attachment_id);
