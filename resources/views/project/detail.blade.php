...
@section('content')
                                ...
                                <div class="row align-items-center g-3">
                                    <div class="col-md-auto">
                                        {!! \App\Helper\Helper::avatar(
                                            ...
                                            'avatar-md',
                                            30,
                                            auth() && auth()->user()->id === $project->user->id,
                                        ) !!}
                                    </div>
                                    <div class="col-md">
                                        <div>
                                            ...
                                            <div class="hstack gap-3 flex-wrap">
                                                <div>Department : <span
                                                        class="fw-medium">{{ $project->department->name }}</span></div>
                                                <div class="vr"></div>
                                                <div>Leader : <span class="fw-medium">{{ $project->user->name }}</span>
                                                </div>
                                                <div class="vr"></div>
                                                <div>Create Date : <span
                                                        class="fw-medium">{{ \App\Helper\Helper::letter_date($project->created_at) }}</span>
                                                </div>
                                                <div class="vr"></div>
                                                <div>Start Date : <span
                                                        class="fw-medium">{{ \App\Helper\Helper::letter_date($project->start_date) }}</span>
                                                </div>
                                                <div class="vr"></div>
                                                <div>Due Date : <span
                                                        class="fw-medium">{{ \App\Helper\Helper::letter_date($project->end_date) }}</span>
                                                </div>
                                                <div class="vr"></div>
                                    ...
                                    <div class="text-muted">
                                        ...
                                        <div class="pt-3 border-top border-top-dashed mt-4">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <h5 class="fs-15 mb-0">
                                                            {{ \App\Helper\Helper::letter_date($project->start_date) }}</h5>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <h5 class="fs-15 mb-0">
                                                            {{ \App\Helper\Helper::letter_date($project->end_date) }}</h5>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-sm-6 mb-3">
                                                    <div>
                                                        ...
                                                        <div
                                                            class="badge bg-{{ \App\Helper\Helper::getStatusColor($project->status) }} fs-12">
                                                            {{ \App\Helper\Helper::getStatus(0, $project->status) }}</div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="pt-3 border-top border-top-dashed mt-4 d-flex justify-content-end">
                                                <a href="{{ url('bigproject/detail/' . $project->big_project->id) }}"
                                ...
                                <div
                                    ...
                                    @if (\App\Helper\Helper::clinicProjectEditable(auth()->user(), $project))
                                        <div class="flex-shrink-0">
                                            <button data-bs-toggle="modal" data-bs-target="#inviteLeaderModal"
                                                onclick="open_invite_leader_modal()" type="button"
                                ...
                                <div class="card-body">
                                    <div data-simplebar style="height: 235px;" class="mx-n3 px-3">
                                        <div class="vstack gap-3">
                                            @foreach ($project->assignLeaders as $item)
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        <div class="flex-grow-1">
                            <div class="hstack text-nowrap gap-2">
                                Tasks <span
                                    class="badge badge-danger badge-soft-secondary">{{ count($project->tasks) }}</span>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form id="form" method="post" action="{{ url('project/invite/' . $project->id) }}">
    ...
    <!-- end modal -->
    <!-- Modal -->
    <div class="modal fade" id="inviteLeaderModal" tabindex="-1" aria-labelledby="inviteLeaderModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header p-3 ps-4 bg-soft-success">
                    <h5 class="modal-title" id="inviteLeaderModalLabel">Leaders</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-4">
                    <form id="form_leader" method="post" action="{{ url('project/invite_leader/' . $project->id) }}">
                        <input name="id" type="hidden" value="{{ $project->id }}">
                        @csrf
                    </form>
                    <div class="search-box mb-3">
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        ...
                        <form method="post" action="{{ url('project/delete_member/' . $project->id) }}">
                            {{ csrf_field() }}
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                        <form method="post" action="{{ url('project/delete_leader/' . $project->id) }}">
                            {{ csrf_field() }}
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                        <form method="post" action="{{ url('project/delete_attachment/' . $project->id) }}">
                            {{ csrf_field() }}
    ...
    <div class="modal fade" id="modal_uplaod" tabindex="-1" aria-labelledby="" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="form" method="post" action="{{ url('project/upload_file/' . $project->id) }}"
    ...
    <script>
        ...
        { // invite leader
            function add_user(obj, i) {
                ...
                console.log(user);
                if (!push_user(user)) {
                    add_member_at_top_modal(user);
                    $(obj).text("Remove");
                } else {
                    delete_member_at_top_modal(user);
                    $(obj).text("Add");
                }
            }
            ...
            function add_member_at_top_modal(user) {
                $('.members_on_modal').append(avatar(user));
            }

            function delete_member_at_top_modal(user) {
