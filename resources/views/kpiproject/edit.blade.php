...
@section('title')
    @lang('translation.create_kpi_big_project')
@endsection
@section('css')
...
@section('content')
    ...
    <form id="form" method="post" action="{{url('kpiproject/edit/'.$project->id)}}" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input name="name" type="text" class="form-control" id="project-title-input" value="{{$project->name}}" placeholder="Enter project title">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Project Description</label>
                            <div class="snow-editor" id="ckeditor-classic" style="height: 300px">{!! $project->description !!}</div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input name="start_date" value="{{$project->start_date}}" type="text" class="form-control" id="datepicker-start-input"
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input name="end_date" value="{{$project->end_date}}" type="text" class="form-control" id="datepicker-deadline-input"
                                           placeholder="Enter due date" data-provider="flatpickr">
                                </div>
                            </div>
                        </div>
