...
@section('title')
    @lang('translation.create_kpi_project')
@endsection
@section('css')
...
@section('content')
    ...
    <form id="form" method="post" action="{{url('kpiproject/create/'.$big_project_id)}}" enctype="multipart/form-data">
        <div class="row">
            @csrf
            <input type="hidden" name="big_project_id" value="{{$big_project_id}}">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
