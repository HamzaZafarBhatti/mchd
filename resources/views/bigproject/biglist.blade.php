...
@section('title')
    @lang('translation.big_project_list')
@endsection
@section('content')
        ...
        <div class="col-sm-auto">
            <div>
                @if(\App\Helper\Helper::clinicBigProjectCreatable(auth()->user(), $code))
                    <a href="{{url('bigcreate/'.$code)}}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Create New</a>
                @endif
            </div>
        </div>
        <div class="col-sm">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <h5 class="mb-0 fs-14 text-center">
                                        <a href="{{url('bigproject/detail/'.$item->id)}}" class="text-dark">
