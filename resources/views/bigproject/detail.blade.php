                                    ...
                                    <div class="text-muted">
                                        ...
                                        <div class="pt-3 border-top border-top-dashed mt-4">
                                            ...
                                            <div class="pt-3 border-top border-top-dashed mt-4 d-flex justify-content-end">
                                                <a href="{{url('biglist/'.$big_project->department_code)}}" class="btn btn-outline-danger w-sm me-1">Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-0 fs-14 text-center">
                                                        <a href="{{url('project/detail/'.$item->id)}}" class="text-dark">
                                                    ...
                                                    <div class="d-flex gap-1 align-items-center my-n2">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="{{url('project/detail/'.$item->id)}}"><i
                                                                        class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                    View</a>

                                                                @if(\App\Helper\Helper::clinicProjectEditable(auth()->user(), $item))
                                                                <a class="dropdown-item" href="{{url('project/edit/'.$item->id)}}"><i
                                                                        class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                                    Edit</a>
    ...
    <div class="modal fade" id="modal_uplaod" tabindex="-1" aria-labelledby=""
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="form" method="post" action="{{url('bigproject/upload_file/'.$big_project->id)}}" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                            <input name="id" type="hidden" value="{{$big_project->id}}">
                            @csrf
                            <div class="mb-3">
    ...
    <div class="modal fade zoomIn" id="edit_modal" tabindex="-1" aria-labelledby="editbigprojectmodal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form id="edit_task" action="{{url('bigproject/m_edit')}}" method="post" class="needs-validation" enctype="multipart/form-data">
                    {{csrf_field()}}
