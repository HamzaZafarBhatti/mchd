                                    ...
                                    <div class="text-muted">
                                        ...
                                        <div class="pt-3 border-top border-top-dashed mt-4">
                                            ...
                                            <div class="pt-3 border-top border-top-dashed mt-4 d-flex justify-content-end">
                                                <a href="{{ url('kpibiglist/' . $big_project->department_code) }}"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-0 fs-14 text-center">
                                                        <a href="{{ url('kpiproject/detail/' . $item->id) }}"
                                                            class="text-dark">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item"
                                                                    href="{{ url('kpiproject/detail/' . $item->id) }}"><i
                                                                        class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                    View</a>

                                                                @if (\App\Helper\Helper::clinicProjectEditable(auth()->user(), $item))
                                                                    <a class="dropdown-item"
                                                                        href="{{ url('kpiproject/edit/' . $item->id) }}"><i
                                                                            class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                                        Edit</a>
                                            ...
                                            <div>
                                                ...
                                                <div class="progress progress-sm animated-progress">
                                                    <div class="progress-bar bg-success" role="progressbar"
                                                        aria-valuenow="{{ \App\Helper\Helper::kpiprogress($item) }}"
                                                        aria-valuemin="0" aria-valuemax="100"
                                                        style="width: {{ \App\Helper\Helper::kpiprogress($item) }}%;">
                                                    </div><!-- /.progress-bar -->
                                                </div><!-- /.progress -->
                                            </div>
                                        @endif
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                        <form method="post" action="{{ url('kpibigproject/delete_manager/' . $big_project->id) }}">
                            {{ csrf_field() }}
    ...
    <div class="modal fade" id="modal_uplaod" tabindex="-1" aria-labelledby="" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="form" method="post" action="{{ url('kpibigproject/upload_file/' . $big_project->id) }}"
    ...
    <div class="modal fade zoomIn" id="edit_modal" tabindex="-1" aria-labelledby="editbigprojectmodal"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form id="edit_task" action="{{ url('kpibigproject/m_edit') }}" method="post" class="needs-validation"
                    enctype="multipart/form-data">
                    {{ csrf_field() }}
