...
@section('title')
    @lang('translation.kpi_big_project_detail')
@endsection
@section('css_bottom')
                                    ...
                                    <div class="text-muted">
                                        ...
                                        <div class="pt-3 border-top border-top-dashed mt-4">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <h5 class="fs-15 mb-0">{{\App\Helper\Helper::letter_date($big_project->start_date)}}</h5>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        <p class="mb-2 text-uppercase fw-medium">Due Date :</p>
                                                        <h5 class="fs-15 mb-0">{{\App\Helper\Helper::letter_date($big_project->end_date)}}</h5>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-sm-6 mb-3">
                                                    <div>
                                                        ...
                                                        <div class="badge bg-{{\App\Helper\Helper::getStatusColor($big_project->status)}} fs-12">{{\App\Helper\Helper::getStatus(0, $big_project->status)}}</div>
                                                    </div>
                                                </div>
                                                    ...
                                                    @if(\App\Helper\Helper::statusChangeable(auth()->user(), $big_project))
                                                        ...
                                                        <div class="mb-4">
                                                            <form id="form_status" method="post" action="{{url('clinic/change_status')}}">
                                                                ...
                                                                <input type="hidden" name="id" value="{{$big_project->id}}">
                                                                <select id="change_status" class="form-control" name="status" data-choices data-choices-search-false>
                                                                    @foreach(config('constants.big_project_status') as $key => $val)
                                                                        @if($key !== "all")
                                                                            <option {{$big_project->status == $key? 'selected' : ''}} value="{{$key}}">{{$val}}</option>
                                                                        @endif
                                                                    @endforeach
                                                                </select>
                                                            </form>
                                            ...
                                            <div class="pt-3 border-top border-top-dashed mt-4 d-flex justify-content-end">
                                                <a href="{{url('kpibiglist/'.$big_project->department_code)}}" class="btn btn-outline-danger w-sm me-1">Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header align-items-center d-flex justify-content-between border-bottom-dashed">
                                    ...
                                    <div class="float-lg-end">
                                        {!! \App\Helper\Helper::avatar($big_project->boss->avatar, $big_project->boss->name, 'avatar-xs', 11, auth() && auth()->user()->id === $big_project->boss->id) !!}
                                    </div>
                                </div>
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        <div class="flex-grow-1">
                            <div class="hstack text-nowrap gap-2">
                                Projects <span class="badge badge-danger badge-soft-secondary">{{count($big_project->projects)}}</span>
                            </div>
                        </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    <h5 class="mb-0 fs-14 text-center">
                                                        <a href="{{url('kpiproject/detail/'.$item->id)}}" class="text-dark">
                                                    ...
                                                    <div class="d-flex gap-1 align-items-center my-n2">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="{{url('kpiproject/detail/'.$item->id)}}"><i
                                                                        class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                    View</a>

                                                                @if(\App\Helper\Helper::clinicProjectEditable(auth()->user(), $item))
                                                                <a class="dropdown-item" href="{{url('kpiproject/edit/'.$item->id)}}"><i
                                                                        class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                                    Edit</a>
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                                ...
                                                <div class="avatar-group">
                                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                                       data-bs-trigger="hover" data-bs-placement="top" title="{{$item->user->name}}">
                                                        {!! \App\Helper\Helper::avatar($item->user->avatar, $item->user->name, 'avatar-xxs', 11, auth() && auth()->user()->id === $item->user->id) !!}
                                                    </a>
                                                </div>

                                                <p class="text-muted ms-auto mb-0 me-2">Tasks : <span class="badge badge-soft-secondary"> {{$item->tasks->count()}}</span></p>
                                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form id="form" method="post" action="{{url('kpibigproject/invite/'.$big_project->id)}}">
...
{{--                            @endforeach--}}
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        ...
                        <form method="post" action="{{url('kpibigproject/delete_leader/'.$big_project->id)}}">
                            {{csrf_field()}}
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                        <form method="post" action="{{url('kpibigproject/delete_attachment/'.$big_project->id)}}">
                            {{csrf_field()}}
    ...
    <div class="modal fade" id="modal_uplaod" tabindex="-1" aria-labelledby=""
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="form" method="post" action="{{url('kpibigproject/upload_file/'.$big_project->id)}}" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                            <input name="id" type="hidden" value="{{$big_project->id}}">
                            @csrf
                            <div class="mb-3">
    ...
    <div id="removeProjectModal" class="modal zoomIn" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form id="form_delete_project" method="post" action="{{url('kpiproject/delete_project')}}">
                @csrf
    ...
    <div class="modal fade zoomIn" id="edit_modal" tabindex="-1" aria-labelledby="editbigprojectmodal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form id="edit_task" action="{{url('kpibigproject/m_edit')}}" method="post" class="needs-validation" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="mb-3">
                                    <div class="snow-editor" id="ckeditor-classic" style="height: 300px">{!! $big_project->description !!}</div>
                                </div>
                            </div>
                        </div>
                        <!--end row-->
