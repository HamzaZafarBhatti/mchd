...
@section('title')
    @lang('translation.create_kpi_task')
@endsection
@section('css')
...
@section('content')
    ...
    <form id="form" method="post" action="{{url('kpitask/create/'.$project_id)}}" enctype="multipart/form-data">
        <div class="row">
            @csrf
            ...
            <div class="col-lg-4">
                ...
                <div class="text-end mb-4">
                    ...
                    @if(\App\Helper\Helper::clinicTaskCreatable(auth()->user(), \App\Models\KpiProject::findOrFail($project_id)))
