...
@section('content')
    ...
    <form id="form" method="post" action="{{url('task/create/'.$project_id)}}" enctype="multipart/form-data">
        <div class="row">
            @csrf
            ...
            <div class="col-lg-4">
                ...
                <div class="text-end mb-4">
                    ...
                    @if(\App\Helper\Helper::clinicTaskCreatable(auth()->user(), \App\Models\Project::findOrFail($project_id)))
