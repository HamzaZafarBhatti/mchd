                                ...
                                <div class="row align-items-center g-3">
                                    <div class="col-md-auto">
                                        {!! \App\Helper\Helper::avatar(
                                            $sub_task->leader->avatar,
                                            $sub_task->leader->name,
                                            'avatar-md',
                                            30,
                                            auth() && auth()->user()->id === $sub_task->leader->id,
                                        ) !!}
                                    </div>
                                    <div class="col-md">
                                        <div>
                                            ...
                                            <div class="hstack gap-3 flex-wrap">
                                                <div>Department : <span
                                                        class="fw-medium">{{ $sub_task->department->name }}</span></div>
                                                <div class="vr"></div>
                                                <div>Leader : <span class="fw-medium">{{ $sub_task->leader->name }}</span>
                                                </div>
                                                <div class="vr"></div>
                                                <div>Create Date : <span
                                                        class="fw-medium">{{ \App\Helper\Helper::letter_date($sub_task->created_at) }}</span>
                                                </div>
                                                <div class="vr"></div>
                                                <div>Start Date : <span
                                                        class="fw-medium">{{ \App\Helper\Helper::letter_date($sub_task->start_date) }}</span>
                                                </div>
                                                <div class="vr"></div>
                                                <div>Due Date : <span
                                                        class="fw-medium">{{ \App\Helper\Helper::letter_date($sub_task->end_date) }}</span>
                                                </div>
                                                <div class="vr"></div>
                        ...
                        <div class="col-xl-9 col-lg-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <h5 class="fs-15 mb-0">
                                                            {{ \App\Helper\Helper::letter_date($sub_task->start_date) }}
                                                        </h5>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <h5 class="fs-15 mb-0">
                                                            {{ \App\Helper\Helper::letter_date($sub_task->end_date) }}</h5>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-sm-6 mb-3">
                                                    <div>
                                                        ...
                                                        <div
                                                            class="badge bg-{{ \App\Helper\Helper::getStatusColor($sub_task->status) }} fs-12">
                                                            {{ \App\Helper\Helper::getStatus(0, $sub_task->status) }}</div>
                                                    </div>
                                                </div>
                            ...
                            <div class="card border">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-3 border-top border-top-dashed mt-4">
                                        <form action="{{ route('kpisubtask.add_comment', $sub_task->id) }}" method="post"
                                            id="form_comment">
    ...
    <div class="modal fade" id="modal_uplaod" tabindex="-1" aria-labelledby="" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="form" method="post" action="{{ url('kpisubtask/upload_file/' . $sub_task->id) }}"
...
@section('script-bottom')
    <script>
        ...
        let user_list = @json($sub_task->assignUsers); { // invite leader
