...
@section('content')
    ...
    <form id="form" method="post" action="{{url('kpisubtask/create/'.$task_id)}}" enctype="multipart/form-data">
        <div class="row">
            @csrf
            ...
            <div class="col-lg-4">
                ...
                <div class="text-end mb-4">
                    ...
                    @if(\App\Helper\Helper::clinicSubTaskCreatable(auth()->user(), \App\Models\KpiTask::findOrFail($task_id)))
