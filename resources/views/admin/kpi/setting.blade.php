...
@section('content')
    @component('components.main_breadcrumb')
        @slot('title') KPI Settings  @endslot
    ...
    <div class="row">
        <div class="col-md-6 col-lg-6">
            <div class="card">
                ...
                <form action="{{url('kpi/add_group')}}" method="post">
                    <div class="card-header align-items-center d-flex">
                        @csrf
                    ...
                    <ul class="list-group">
                        @foreach($groups as $item)
                            <li class="list-group-item d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="javascript:edit_group({{json_encode($item)}})">
                                        <i style="font-size: 16pt" class="ri-edit-2-fill text-success px-2"></i>
                                    </a>
                                    <a href="javascript:delete_group({{json_encode($item)}})">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="card">
                ...
                <form action="{{url('kpi/add_unit')}}" method="post">
                    <div class="card-header align-items-center d-flex">
                        @csrf
                        <div class="input-group">
                            <input name="name" type="text" class="form-control" required>
                    ...
                    <ul class="list-group">
                        @foreach($units as $item)
                            <li class="list-group-item d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="javascript:edit_unit({{json_encode($item)}})">
                                        <i style="font-size: 16pt" class="ri-edit-2-fill text-success px-2"></i>
                                    </a>
                                    <a href="javascript:delete_unit({{json_encode($item)}})">
                                        <i style="font-size: 16pt" class="ri-delete-bin-6-fill text-danger px-2"></i>
                                    </a>
                                </div>
                            </li>
    ...
    <div class="modal fade" id="edit_group" tabindex="-1" aria-labelledby="edit_group"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{url('kpi/edit_gu')}}" method="post">
                    @csrf
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        ...
                        <form method="post" action="{{url('kpi/delete_gu')}}">
                            @csrf
