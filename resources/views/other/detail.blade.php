        ...
        <div class="col-xxl-3">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <form id="form_status" method="post" action="{{url('tasks/change_status')}}">
                            @csrf
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        ...
                        @if(\App\Helper\Helper::otherTaskEditable(auth()->user(), $task))
        ...
        <div class="col-xl-12 col-md-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    @if(\App\Helper\Helper::otherSubTaskCreatable(auth()->user(), $task))
                    ...
                    <div class="table-responsive table-card">
                        <table class="table table-nowrap table-centered align-middle">
                            ...
                            @foreach($task->subTasks as $item)
                                <tr>
                                    <td class="fw-medium">
                                        <a href="{{url('tasks/sub_detail/'.$item->id)}}" class="text-reset">
                                            {{\App\Helper\Helper::limitString($item->name, 25)}}
                                        </a>
                                    </td>

                                    <td>
                                        {!! \App\Helper\Helper::avatar($item->leader->avatar, $item->leader->name, 'avatar-xs', 11, auth() && auth()->user()->id === $item->leader->id) !!}
                                    </td>
                                            ...
                                            @foreach($item->assignUsers as $assignUser)
                                                <div class="avatar-group-item">
                                                    <a href="javascript: void(0);" class="d-inline-block">
                                                        {!! \App\Helper\Helper::avatar($assignUser->avatar, $assignUser->name, 'avatar-xs', 11, auth() && auth()->user()->id === $assignUser->id) !!}
                                                    </a>
                                                </div>
                                            @endforeach
                                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form id="form" method="post" action="{{url('tasks/invite/')}}">
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        ...
                        <form method="post" action="{{url('tasks/delete_member/')}}">
                            {{csrf_field()}}
    ...
    <div class="modal fade zoomIn" id="edit_modal" tabindex="-1" aria-labelledby="createProjectModelLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form id="edit_task" action="{{url('tasks/edit')}}" method="post" class="needs-validation" enctype="multipart/form-data">
                    {{csrf_field()}}
    ...
    <div class="modal fade" id="modal_uplaod" tabindex="-1" aria-labelledby=""
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="form" method="post" action="{{url('tasks/upload_file/')}}" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                        <input name="id" type="hidden" value="{{$task->id}}">
                        @csrf
                        <div class="mb-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="hstack gap-2 justify-content-center mt-3">
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cancel</button>
                        <form method="post" action="{{url('tasks/delete_attachment/')}}">
                            {{csrf_field()}}
    ...
    <div class="modal fade zoomIn" id="createProjectModal" tabindex="-1" aria-labelledby="createProjectModelLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form id="sub_create_task" action="{{url('tasks/sub_create')}}" method="post" class="needs-validation" enctype="multipart/form-data">
                    {{csrf_field()}}
...
<script>
    ...
    {// create sub modal
        ...
        let sub_candidate_user_list = @json($task->assignUsers);
        let sub_user_list = [];
